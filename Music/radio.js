...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    let resultsEmbed = new Discord.MessageEmbed()
      ...
      .addFields(
        {
          name: `***:radio: Standard Radio***`, value: `**1:  ** [\`${Radiostations[1 - 1].split(" ")[0]}\`](${Radiostations[1 - 1].split(" ")[1]})
        ...
        **5:  ** [\`${Radiostations[5 - 1].split(" ")[0]}\`](${Radiostations[5 - 1].split(" ")[1]})
        ` , inline: true
          ...
          name: `***:radio: Standard Radio***`, value: `**6:  ** [\`${Radiostations[6 - 1].split(" ")[0]}\`](${Radiostations[6 - 1].split(" ")[1]})
...
**34: ** [\`${Radiostations[34 - 1].split(" ")[0]}\`](${Radiostations[34 - 1].split(" ")[1]})`, inline: true
    ...
    const song = {
      title: args2[0],
      url: args2[1],
      thumbnail: "https://i.redd.it/y3wduhwn4gd61.jpg",
      duration: 10000,
    };
    let a, b;
    if (!serverQueue) {
