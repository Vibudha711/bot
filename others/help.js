...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    .addField("• Important Links", `**[Invite Link](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)\`|\`[Free Nitro](https://www.youtube.com/watch?v=iik25wqIuFo)\`|\`[Epilepsy](http://www.staggeringbeauty.com/)**`)
    .addField(`All Commands are Below `)
